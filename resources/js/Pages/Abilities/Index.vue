<template>
    ...
    <div class="mx-2 mx-auto">
        <Card class="mx-auto">
            ...
            <template #content>
                <DataTable :value="abilities" stripedRows tableStyle="min-width: 50rem">
                    <template #header>
                        <Link :href="route('admin.abilities.create')">
                            <Button raised label="Add New Ability" icon="pi pi-plus" icon-pos="left" />
                        </Link>
                    </template>
                    ...
                    <Column header="Action">
                        <template #body="props">
                            <Link
                                :href="route('admin.abilities.edit', props.data.id)">
...
const showDeleteConfirm = (data) => {
    confirm.require({
        ...
        accept: () => {
            router.post(route("admin.abilities.delete", data.id));
        },
        reject: () => {
