...
<template>
    <div
        class="p-card p-card-content w-full md:w-1/2 lg:w-1/4 mx-auto"
    ...
    >
        ...
        <div>
            <div class="w-full text-center p-4" v-for="ability in unit.abilities">
                ...
                <pre class="text-sm"><span>{{ ability.description }}</span></pre>
            </div>
            <div class="flex flex-row justify-between p-4">
                <div class="rounded-full bg-black p-2 text-xl">+{{ unit.cinder }} <img :src="Cinder" class="inline" /></div>
                <div class="rounded-full bg-black p-2 text-xl">
                    +{{ unit.speed }}
        ...
        <div class="flex items-center">
            <div class="rounded-full bg-black p-2 mb-2 text-2xl mx-auto">
